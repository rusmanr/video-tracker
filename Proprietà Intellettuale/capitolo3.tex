...
Si affronterano ora gli articoli di maggiorni rilievo della licenza nella sezione \ref{sec:caratteristiche}.

\subsection{Caratteristiche} \label{sec:caratteristiche}
