...
\caption{\textit{movie12 screenshot}\label{fig:movie12b screenshot}}
\end{figure}
...
\caption{\textit{Test 1: Previsioni}\label{fig:Test 1b}}
\end{figure}
...
\caption{\textit{Test 2: Previsioni}\label{fig:Test 2b}}
\end{figure}
...
\caption{\textit{Test 3: Previsioni}\label{fig:Test 3b}}
\end{figure}
...
\caption{\textit{Test 4: Previsioni}\label{fig:Test 4b}}
\end{figure}
...
\caption{\textit{Test 5: Previsioni}\label{fig:Test 5b}}
\end{figure}
...
\centering
\includegraphics[scale=0.4]{../../esperimenti/movie12/mod_3-Q_1000-S_1000/plot-distances.png}
\caption{\textit{Test 6: Previsioni}\label{fig:Test 6b}}
\end{figure}
...
\caption{\textit{Test 7: Previsioni}\label{fig:Test 7b}}
\end{figure}
...
\caption{\textit{Test 8: Previsioni}\label{fig:Test 8b}}
\end{figure}
